...
class Admin extends ActiveRecord{
    ...
    public function rules(){
        ...
        return [
            ...
            ['adminpass','validatePass','message'=>'用户名或者密码错误','on'=>['login','changeemail']],
            ...
            ['adminuser','unique','message'=>'此管理员账号已被注册','on'=>['adminadd','changeemail']],
    ...
    public function seekPass($data){
        ...
        if($this->load($data)&&$this->validate()){
            ...
            $mailer = Yii::$app->mailer->compose('seekpass',['html'=>'html','adminuser'=>$data['Admin']['adminuser'],'time' => $time, 'token' => $token]);
            $mailer->setFrom("14789856061@163.com");
            $mailer->setTo($data['Admin']['adminemail']);
            $mailer->setSubject("慕课商城找回密码");
            if($mailer->send()){
                return true;
            }
        }
